...
const PaiementPage = () => {
    ...
    // ÉTAT CRITIQUE POUR LA REDIRECTION SÉCURISÉE (Contient le token)
    const [redirectionData, setRedirectionData] = useState(null); 
    // Si non-null, affiche l'écran d'alerte et prépare la redirection.
        ...
        return (
            <div style={{ textAlign: 'center', marginTop: '50px', padding: '30px', backgroundColor: '#fff3cd', border: '1px solid #ffc107', borderRadius: '8px', maxWidth: '600px', margin: '50px auto' }}>
                ...
                <p style={{ fontWeight: 'bold' }}>
                    🚨 EN CAS DE BLOCAGE : Si la page PayDunya ne vous redirige pas, veuillez cliquer sur ce lien (ou le retrouver sur WhatsApp) :
                </p>
    ...
    return (
        <div className="card-container" style={cardStyle}>
            ...
            {/* LOGO TEXTE STYLISÉ (Corrige l'erreur 404) */}
