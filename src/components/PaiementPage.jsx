...
const INIT_PAYMENT_URL = BASE_SERVER_URL; 
// **********************************************
...
  // Utiliser 'Orange Money' ou 'Moov Money' comme valeur par défaut
  const [clientInfo, setClientInfo] = useState(null);
  const [nbTickets, setNbTickets] = useState(1);
  const [plateforme, setPlateforme] = useState('Orange Money'); // Défaut corrigé
...
        provider: plateforme, // ENVOIE "Orange Money" ou "Moov Money"
      });
...
        >
          {/* ✅ CORRECTION FINALE : Utilisation des noms exacts de la console YengaPay */}
          <option value="Orange Money">Orange Money</option>
          <option value="Moov Money">Moov Money</option>
             {/* Ajout des autres si vous voulez les tester ou les rendre visibles, mais concentrez-vous sur ceux-ci */}
